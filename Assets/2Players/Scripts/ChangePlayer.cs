...
public class ChangePlayer : MonoBehaviour {
	...
	void SetPlayer(bool first)
	{
		...
		player1.GetComponent<Platformer2DDualControl> ().enabled = control;
		player1.GetComponent<Platformer2DDualControl> ().SetPlayer(true);
		player1.GetComponent<PlatformerCharacterFollower> ().enabled = follow;
		player1Text.color = first ? Color.red : Color.white;
		
		player2.GetComponent<Platformer2DDualControl> ().enabled = !control;
		player2.GetComponent<Platformer2DDualControl> ().SetPlayer(true);
	...
	void SetDualMode()
	{
		...
		player2.GetComponent<Platformer2DDualControl> ().SetPlayer (false);
